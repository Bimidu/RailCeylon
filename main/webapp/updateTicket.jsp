...
<div class="container pt-5 mt-5 bg-dark-subtle rounded mb-5 pb-5">
  <div class="row justify-content-center">
    <div class="col-lg-6">
      <form action="updateTicket" method="POST" id="passenger-form" onsubmit="return validateForm();">
        ...
        <div class="mb-3">
          ...
          <input type="date" id="passenger-up-ddate" name="passenger-up-ddate" value="<%=ddate%>" class="form-control">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" id="passenger-up-name" name="passenger-up-name" value="<%=name%>" class="form-control" required>
        </div>

        <div class="mb-3">
          <label for="passenger-age" class="form-label">Age</label>
          <input type="text" id="passenger-up-age" name="passenger-up-age" value="<%=age%>" class="form-control" required>
        </div>

        <div class="mb-3">
          <label for="passenger-nic" class="form-label">NIC Number</label>
          <input type="text" id="passenger-up-nic" name="passenger-up-nic" value="<%=nic%>" class="form-control" required>
        </div>

        <div class="mb-3">
          <label for="passenger-address" class="form-label">Address</label>
          <input type="text" id="passenger-up-address" name="passenger-up-address" value="<%=address%>" class="form-control" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" id="passenger-up-phone" name="passenger-up-phone" value="<%=phone%>" class="form-control" required>
        </div>
